...
def File_creator_directory():
    ...
    while file_creator_directory_creator == "on" :
        with sr.Microphone(device_index=0) as source_for_file_creator_directory_name_chose: 
                ...
                audio_for_file_creator_directory_creator = r.listen(source_for_file_creator_directory_name_chose)

        speech_for_file_creator_directory_creator = r.recognize_google(audio_for_file_creator_directory_creator, language="ru_RU")
